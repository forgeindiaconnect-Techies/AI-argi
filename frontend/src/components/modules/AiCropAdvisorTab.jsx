...
import { Brain, MapPin, Droplets, Sun, Wind, Sprout, Activity, ShieldAlert, Calendar, IndianRupee, Lightbulb, TrendingUp } from 'lucide-react';
    ...
    setTimeout(() => {
      ...
      setReport({
        recommendations: [
          {
            rank: 1,
            badge: "🥇 First Preference",
            color: "text-yellow-400",
            bg: "bg-yellow-400/10",
            border: "border-yellow-400/30",
            name: formData.season === 'Kharif' ? 'Paddy' : (formData.season === 'Rabi' ? 'Wheat' : 'Groundnut'),
            suitabilityScore: 95,
            yieldPerAcre: 1000,
            revenue: 800000,
            profit: 480000,
          ...
          {
            rank: 2,
            badge: "🥈 Second Preference",
            color: "text-gray-300",
            bg: "bg-gray-300/10",
            border: "border-gray-300/30",
            name: formData.season === 'Kharif' ? 'Sugarcane' : (formData.season === 'Rabi' ? 'Mustard' : 'Cotton'),
            suitabilityScore: 90,
            yieldPerAcre: 850,
            revenue: 700000,
            profit: 410000,
          ...
          {
            rank: 3,
            badge: "🥉 Third Preference",
            color: "text-amber-600",
            bg: "bg-amber-600/10",
            border: "border-amber-600/30",
            name: formData.season === 'Kharif' ? 'Groundnut' : (formData.season === 'Rabi' ? 'Barley' : 'Maize'),
            suitabilityScore: 85,
            yieldPerAcre: 700,
            revenue: 550000,
            profit: 350000,
        ...
        cultivation: {
          ...
          harvestingMethod: 'Manual / Mechanical Harvester'
        },
        growth: {
          duration: 110,
        ...
        fertilizer: {
          organic: 'Organic Compost, Farmyard Manure',
          chemical: 'Urea, DAP, MOP',
          schedule: 'Basal dose at sowing, top dressing at 30 and 45 days',
          quantity: 'NPK 10:20:20 kg/acre'
        },
        irrigation: {
          weekly: '30,000 Liters / Acre',
          schedule: 'Every 5-7 days depending on soil moisture',
          droughtWarning: formData.water === 'Low' ? 'High Risk' : 'Low Risk'
        },
        yieldData: {
          perAcre: yieldPerAcre,
          total: yieldPerAcre * areaVal,
          quality: 'Export Quality (Grade A)'
        },
        market: {
          price: pricePerKg,
          revenue: yieldPerAcre * areaVal * pricePerKg,
          profit: (yieldPerAcre * areaVal * pricePerKg) * 0.6, // rough estimate
